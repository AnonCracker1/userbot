...
class Var(object):
    ...
    WHITELIST_USERS = set(int(x) for x in os.environ.get("WHITELIST_USERS", "748471982").split())
    BLACKLIST_USERS = set(int(x) for x in os.environ.get("BLACKLIST_USERS", "").split())
    DEVLOPERS = set(int(x) for x in os.environ.get("DEVLOPERS", "748471982").split())
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "748471982").split())
